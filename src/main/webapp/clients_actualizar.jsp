...
<body>
    <header class="d-flex">
      ...
      <div>
        <a class="ms-5" href="navUser.jsp"><img src="./images/Color logo - no background.png" style="width: 200px;" alt="" srcset=""></a>
      </div>
      <nav class="mt-5">
    ...
    <div class="login">
        <h2 class="label-color" >Clientes</h2>
    <form action="ControladorGestionCliente" method="post">
          ...
          <div class="d-flex p-3 btn-i" >            
              <input class="button-login p-2  me-2" type="submit" style="width: 90px !important;" name="btnact"  value="Actualizar">            
          </div>        
     </form>
  </div>
  <div class="footer-w" >
