...
<body>
	...
	<div class="login"
		style="width: 800px; margin-left: 500px !important; background-color: rgba(255, 255, 255, 0.664) !important; margin-top: 2rem !important;">
		<h2>Agregar proveedor</h2>
		<form action="ControladorGestionProveedor" method="post">
			<div class="form">
				<div class="grid-50 container-95">
					<div class="p-3 me-1 mb-3">
						<div class="">
							<label for="cedula"> Nit <input
								style="margin-left: 110px;" type="text" name="nit"
								id="nit" required />
							</label>
						</div>
					</div>
					<div class=" p-3 me-4 mb-3">
						<div class="">
							<label for="usuario"> Telefono <input
								style="margin-left: 59.54px;" type="text" name="telefono"
								id="usuario" required />
							</label>
						</div>
					</div>
					<div class="p-3 me-2 mb-3">
						<div class="">
							<label for="Nombre"> Nombre Proveedor <input type="text"
					...
					<div class="p-3 me-2 mb-3">
						<div class="">
							<label for="contraseña"> Ciudad <input
								style="margin-left: 70px;" type="text" name="ciudad"
								id="ciudad" required />
							</label>
						</div>
					</div>
			...
			<div class="d-flex p-3"
				style="align-items: center; margin-left: 15rem !important;">
				<input class="button-login p-2  me-5" type="submit"
					style="width: 90px !important; margin-left: 80px;" name="btnins"
					value="Crear">
			</div>
		</form>
	</div>
