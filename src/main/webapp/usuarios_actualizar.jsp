		...
		<form action="ControladorGestionUsuario" method="post">
			<div class="form">
				<div class="grid-50 container-95">
					<div class="p-3 me-2 mb-3">
						<div class="">
							<label for="cedula"> Cedula <input
								style="margin-left: 80px;" type="text" name="cedula" id="Cedula"
								required />
							</label>
						</div>
					</div>
					<div class=" p-3 me-4 mb-3">
						<div class="">
							<label for="usuario"> Usuario <input
								style="margin-left: 20px;" type="text" name="usuario"
								id="usuario" required />
							</label>
						</div>
					</div>
					...
					<div class="p-3 me-2 mb-3">
						<div class="">
							<label for="contraseña"> Contraseña <input type="text"
								name="contraseña" id="contraseña" required />
							</label>
						</div>
					</div>
					<div class="p-3 me-2 mb-3">
						<div class="">
							<label for="correo"> Correo Electronico <input
			...
			<div class="d-flex p-3"
				style="align-items: center; margin-left: 20rem !important;">
				<input class="button-login p-2  me-5"
					style="width: 90px !important;" type="submit" name="btnact"
					value="Actualizar">
			</div>
		</form>
	</div>
