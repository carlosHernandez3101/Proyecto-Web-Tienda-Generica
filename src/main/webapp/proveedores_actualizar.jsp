...
<body>
    ...
    <li class=" ms-5 nav-item dropdown">
      ...
      <div class="login" style="width: 800px;margin-left: 500px !important; background-color: rgba(255, 255, 255, 0.664) !important;margin-top:2rem !important;">
        <h2 >Proveedores</h2>
        <form action="ControladorGestionProveedor" method="post">
          <div class="form">
            ...
            <div class="d-flex p-3" style="align-items: center; margin-left: 15rem !important;">            
                <input class="button-login p-2  me-5" type="submit" style="width: 90px !important; margin-left: 80px;" name="btnact"  value="Actualizar">            
            </div>        
       </form>
    </div>
</div>
