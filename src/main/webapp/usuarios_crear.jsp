...
<body>
   <header class="d-flex">
    ...
    <div class="login">
        <h2 class="label-color">Agregar Usuario</h2>
      <form action="ControladorGestionUsuario" method="post">
          <div class="form">
              <div class="grid-50 container-95">
                  <div class="p-3 me-1 mb-3">
                      <div >
                          <label for="cedula" class="label-color" style="margin-left: 21px !important;">
                              Cedula
                  ...
                  <div class=" p-3 me-4 mb-3">
                      <div class="">
                          <label for="usuario" class="label-color" style="margin-left: 21px !important;">
                              Usuario
                  ...
                  <div class="p-3 me-2 mb-3">
                      <div class="">
                          <label for="Nombre" class="label-color" style="margin-left: 21px !important;">
                              Nombre Completo
                  ...
                  <div class="p-3 me-2 mb-3">
                      <div class="">
                          <label for="contrase�a" class="label-color" style="margin-left: 21px !important;">
                              Contrase�a
                              <input type="text" name="contrase�a" id="contrase�a" />
                          </label>                   
                      </div>
                  </div>
                  <div class="p-3 me-2 mb-3">
                      <div class="">
                          <label for="correo" class="label-color" style="margin-left: 21px !important;">
                              Correo Electronico
          ...
          <div class="d-flex p-3 btn-i" >            
            <input class="button-login p-2  me-5" type="submit" style="width: 90px !important;" name="btnins"  value="Crear" required>            
        </div>        
     </form>
    </div>
    <div class="mt-5" style="background-color: rgba(0, 0, 0, 0.452);height: 250px;">
      <div class="mb-5 mt-5 d-flex" >
        ...
        <div class="label-color  ms-5 mt-5">      
          <p><b>Autores: </b>Carlos Hernandez, Jhon Rubiano, Jamilton Vidal, Sandra Rodr�guez</p>
        </div>  
