   ...
   <div class="login" style="width: 800px;margin-left: 400px !important; background-color: rgba(255, 255, 255, 0.664) !important;margin-top:2rem !important;">
    ...
    <form action="">
            ...
            <div class="grid-50 container-95">
                <div class="p-3 me-1 mb-3">
                    <div class="">
                        <label for="cedula">
                            Nit
                            <input style="margin-left: 110px;"type="number" name="cedula" id="Cedula" required/>
                        </label>                   
                    </div>
                </div>
                <div class=" p-3 me-4 mb-3">
                    <div class="">
                        <label for="usuario">
                            Telefono
                            <input style="margin-left: 59.54px;" type="number" name="usuario" id="usuario" required/>
                        </label>                   
                    </div>
                </div>
        ...
        <div class="d-flex p-3" style="align-items: center; margin-left: 10rem !important;">
            ...
            <input class="button-login p-2  me-5" type="submit" style="width: 90px !important;" name="btncon"  value="Crear">
            <input  class="button-login p-2  me-5"type="submit" name="btnact"  value="Actualizar">
            <input class="button-login btn-delete p-2" type="submit" name="btneli"  value="Eliminar">
        </div>        
   </form>
</div>
