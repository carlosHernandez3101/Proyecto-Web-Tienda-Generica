...
<body>
    ...
    <div class="login">
        <h2 class="label-color">Consultar Usuarios</h2>
		<form action="ControladorGestionUsuario" method="post">
          ...
          <div class="d-flex p-3 btn-i" >            
            <input class="button-login p-2  me-5" type="submit" style="width: 90px !important;" name="btncon"  value="Consultar" required>            
        </div>        
     </form>
    </div>
