    ...
    <div class="login">
      ...
      <form action="ControladorGestionUsuario" method="post">
          ...
          <div class="d-flex p-3 btn-i" >            
            <input class="button-login p-2  me-5" type="submit" style="width: 90px !important;" name="btneli"  value="Eliminar" required>            
        </div>        
     </form>
    </div>
