...
<body>
    ...
    <div class="login">
        <h2 class="label-color">Actualizar Proveedores</h2>
        <form action="ControladorGestionProveedor" method="post">
          <div class="form">
              <div class="grid-50 container-95">
                  <div class="p-3 me-1 mb-3">
                      <div >
                          <label for="nit" class="label-color" style="margin-left: 21px !important;">
                              Nit
                  ...
                  <div class=" p-3 me-4 mb-3">
                      <div class="">
                          <label for="telefono" class="label-color" style="margin-left: 21px !important;">
                              Telefono
                  ...
                  <div class="p-3 me-2 mb-3">
                      <div class="">
                          <label for="ciudad" class="label-color" style="margin-left: 21px !important;">
                              Ciudad
                  ...
                  <div class="p-3 me-2 mb-3">
                      <div class="">
                          <label for="direccion" class="label-color" style="margin-left: 21px !important;">
                              Direccion
          ...
          <div class="d-flex p-3 btn-i" >            
            <input class="button-login p-2  me-5" type="submit" style="width: 90px !important;" name="btnact"  value="Actualizar">            
        </div>        
     </form>
    </div>
    <div class="footer-w" >
