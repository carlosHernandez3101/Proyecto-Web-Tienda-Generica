...
<body>
    ...
    <div class="login" style="width: 27rem;margin-left: auto !important;">
        <h2 class="label-color">Reportes</h2>
        <form action="">
                        
            <div class="d-flex p-3 content">            
                <a href="listado_usuarios.jsp" class="button-login p-2  me-5 link-reportes"  name="btnlist" > Listado de Usarios</a>            
            </div>
            <div class="d-flex p-3 content">            
                <a href="listado_clientes.jsp" class="button-login p-2  me-5 link-reportes" name="btncli" > Listado de Clientes</a>            
            </div>
            <div class="d-flex p-3 content">            
                <a href="ventas_cliente.jsp" class="button-login p-2  me-5 link-reportes"  name="btnvent"> Ventas por Cliente</a>            
            </div>
