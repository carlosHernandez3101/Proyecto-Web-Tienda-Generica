...
<body>
    ...
    <div class="login">
        <h2 class="label-color">Consultar Proveedores</h2>
        <form action="ControladorGestionProveedor" method="post">
          <div class="form">              
                  <div class="p-3 mb-3" style="margin-left: 28%;">
                      <div >
                          <label for="nit" class="label-color">
                              Nit
          ...
          <div class="d-flex p-3 btn-i">            
            <input class="button-login p-2  me-5" type="submit" style="width: 90px !important;" name="btncon"  value="Consultar">            
        </div>        
     </form>
    </div>
    <div class="footer-w" >
