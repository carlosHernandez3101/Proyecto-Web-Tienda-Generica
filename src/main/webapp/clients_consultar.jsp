        ...
        <form action="ControladorGestionCliente" method="post">
          <div class="form">
            ...
            <div class="d-flex p-3 btn-i" style="align-items: center; margin-left: 10rem !important;">            
                <input class="button-login p-2  me-5" type="submit" style="width: 90px !important; margin-left: 70px;" name="btncon"  value="Consultar">            
            </div> 
        </div>      
     </form>
    </div>
